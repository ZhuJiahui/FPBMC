...
if __name__ == '__main__':
    ...
    #read_filename1 = root_directory + u'dataset/high_quality_data/weibo_class_tag.txt'
    read_filename1 = root_directory + u'dataset/sample_kmeans/classification_result.txt'
    read_filename2 = root_directory + u'dataset/global/weibo_class_tag.txt'
    #read_filename2 = root_directory + u'dataset/sample_kmeans/cluster_tag.txt'
