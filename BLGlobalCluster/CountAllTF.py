...
if __name__ == '__main__':
    ...
    read_directory1 = root_directory + u'dataset/segment/weibo_segment'
    read_directory2 = root_directory + u'dataset/segment/word_list'
    write_directory = root_directory + u'dataset/segment/tf'
